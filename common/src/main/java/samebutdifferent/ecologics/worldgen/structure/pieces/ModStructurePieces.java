...
public class ModStructurePieces 
{
    ...
    public static final StructurePieceType DESERT_RUIN = Registry.register(BuiltInRegistries.STRUCTURE_PIECE, Identifier.fromNamespaceAndPath(Ecologics.MOD_ID, "drp"), (StructureTemplateType)DesertRuinPieces.DesertRuinPiece::create);
}
