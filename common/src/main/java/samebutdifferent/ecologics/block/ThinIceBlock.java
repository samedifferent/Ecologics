...
public class ThinIceBlock extends IceBlock {
    ...
    public void fallOn(Level pLevel, BlockState pState, BlockPos pPos, Entity pEntity, float pFallDistance) {
        if (pEntity instanceof LivingEntity entity && entity.getType().is(ModTags.EntityTypeTags.BREAKS_THIN_ICE) && EnchantmentHelper.getEnchantmentLevel(Enchantments.FALL_PROTECTION, entity) == 0 && pFallDistance > 1) {
