    ...
    public static void onBiomeLoad(BiomeLoadingEvent event) {
        ...
        if (biomeName != null) {
            if (biomeName.equals(Biomes.BEACH.location())) {
                if (ModConfiguration.GENERATE_COCONUT_TREES.get()) builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.TREES_BEACH.getHolder().orElseThrow());
