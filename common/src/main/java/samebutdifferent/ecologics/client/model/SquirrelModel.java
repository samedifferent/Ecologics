...
public class SquirrelModel extends HierarchicalModel<Squirrel> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition root = partdefinition.addOrReplaceChild("root", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -4.0F, -2.5F, 6.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 17.0F, 0.5F, 0.3927F, 0.0F, 0.0F));
        PartDefinition head = root.addOrReplaceChild("head", CubeListBuilder.create().texOffs(16, 13).addBox(-2.0F, -3.6667F, -3.3333F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition tail = root.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(0, 13).addBox(-2.0F, -6.8333F, -0.3333F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition left_arm = root.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(10, 29).addBox(-1.0F, -0.2929F, -4.2071F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, -2.0F, -2.0F, 0.7854F, 0.0F, 0.0F));
        PartDefinition right_arm = root.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(10, 29).mirror().addBox(-1.0F, -0.2929F, -4.2071F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.0F, -2.0F, -2.0F, 0.7854F, 0.0F, 0.0F));
        PartDefinition left_leg = root.addOrReplaceChild("left_leg", CubeListBuilder.create(), PartPose.offset(0.0F, 7.0F, -0.5F));
        ...
        PartDefinition right_leg = root.addOrReplaceChild("right_leg", CubeListBuilder.create(), PartPose.offset(0.0F, 7.0F, -0.5F));
