...
{	
    ...
    public static final Block AZALEA_SHELF = registerBlock("azalea_shelf", ShelfBlock::new, BlockBehaviour.Properties.of().strength(1.0F).sound(SoundType.WOOD), true);
    ...
    public static final Block COCONUT_SHELF = registerBlock("coconut_shelf", ShelfBlock::new, BlockBehaviour.Properties.of().strength(1.0F).sound(SoundType.WOOD), true);
    ...
    public static final Block WALNUT_SHELF = registerBlock("walnut_shelf", ShelfBlock::new, BlockBehaviour.Properties.of().strength(1.0F).sound(SoundType.WOOD), true);
    ...
    public static final Block SANDCASTLE = registerBlock("sandcastle", SandcastleBlock::new, Properties.of().mapColor(MapColor.SAND).strength(0.7F).sound(SoundType.SAND).pushReaction(PushReaction.DESTROY).noOcclusion().randomTicks(), true);
