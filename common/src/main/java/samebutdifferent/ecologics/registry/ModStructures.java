...
public class ModStructures<S extends Structure>
{
    ...
    public static <S extends Structure> StructureType<S> registerStructure(String name, MapCodec<S> codec) {
    	return Registry.register(BuiltInRegistries.STRUCTURE_TYPE, ResourceLocation.fromNamespaceAndPath(Ecologics.MOD_ID, name), () -> codec);
    }
    
    public static final ArrayList<Pair<ResourceLocation, StructureType<?>>> STRUCTURES = new ArrayList<>();
