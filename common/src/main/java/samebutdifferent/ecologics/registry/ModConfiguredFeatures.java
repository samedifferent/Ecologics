...
public class ModConfiguredFeatures {
    ...
    public static final Holder<ConfiguredFeature<RootSystemConfiguration, ?>> ROOTED_AZALEA_TREE = FeatureUtils.register("rooted_azalea_tree", Feature.ROOT_SYSTEM, new RootSystemConfiguration(PlacementUtils.inlinePlaced(ModConfiguredFeatures.AZALEA_TREE), 3, 3, BlockTags.AZALEA_ROOT_REPLACEABLE, BlockStateProvider.simple(Blocks.ROOTED_DIRT), 20, 100, 3, 2, BlockStateProvider.simple(Blocks.HANGING_ROOTS), 20, 2, BlockPredicate.allOf(BlockPredicate.anyOf(BlockPredicate.matchesBlocks(List.of(Blocks.AIR, Blocks.CAVE_AIR, Blocks.VOID_AIR, Blocks.WATER)), BlockPredicate.matchesTag(BlockTags.LEAVES), BlockPredicate.matchesTag(BlockTags.REPLACEABLE_PLANTS)), BlockPredicate.matchesTag(Direction.DOWN.getNormal(), BlockTags.AZALEA_GROWS_ON))));
    public static final Holder<ConfiguredFeature<MossPatchFeatureConfiguration, ?>> SURFACE_MOSS_PATCH = FeatureUtils.register("surface_moss_patch", ModFeatures.SURFACE_MOSS_PATCH.get(), new MossPatchFeatureConfiguration(96, 7, 3, true, true, true, List.of(Blocks.STONE, Blocks.ANDESITE, Blocks.DIORITE, Blocks.GRANITE, Blocks.DRIPSTONE_BLOCK, Blocks.CALCITE, Blocks.TUFF, Blocks.DEEPSLATE)));
}
