...
public class ModEntityTypes {
    public static final Supplier<EntityType<CoconutCrab>> COCONUT_CRAB = CommonPlatformHelper.registerEntityType("coconut_crab", CoconutCrab::new, MobCategory.CREATURE, 1.0F, 1.0F, 10);
