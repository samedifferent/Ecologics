...
public class ModEntityTypes
{
    ...
    public static final EntityType<Boat> MAPLE_BOAT = registerEntityType("maple_boat", EntityType.Builder.of(boatFactory(() -> ModItems.MAPLE_BOAT), MobCategory.MISC).sized(1.375F, 0.5625F).clientTrackingRange(10).build(ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath(Ecologics.MOD_ID, "maple_boat"))));
    public static final EntityType<ChestBoat> MAPLE_CHEST_BOAT = registerEntityType("maple_chest_boat", EntityType.Builder.of(chestBoatFactory(() -> ModItems.MAPLE_CHEST_BOAT), MobCategory.MISC).sized(1.375F, 0.5625F).clientTrackingRange(10).build(ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath(Ecologics.MOD_ID, "maple_chest_boat"))));
