...
public class ModEntityTypes {
    ...
    public static final Supplier<EntityType<Squirrel>> SQUIRREL = CommonPlatformHelper.registerEntityType("squirrel", Squirrel::new, MobCategory.CREATURE, 1.0F, 0.8F, 8);
}
