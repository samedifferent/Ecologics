...
public class ModItems {
    ...
    public static final Supplier<Item> MUSIC_DISC_COCONUT = CommonPlatformHelper.registerItem("music_disc_coconut", () -> new RecordItem(10, ModSoundEvents.MUSIC_DISC_COCONUT.get(), new Item.Properties().stacksTo(1).tab(Ecologics.TAB).rarity(Rarity.RARE)));
    ...
    public static final Supplier<Item> COCONUT_BOAT = CommonPlatformHelper.registerItem("coconut_boat", () -> new ModBoatItem("coconut", new Item.Properties().stacksTo(1).tab(Ecologics.TAB)));
    ...
    public static final Supplier<Item> WALNUT_BOAT = CommonPlatformHelper.registerItem("walnut_boat", () -> new ModBoatItem("walnut", new Item.Properties().stacksTo(1).tab(Ecologics.TAB)));
    public static final Supplier<Item> WALNUT = CommonPlatformHelper.registerItem("walnut", () -> new Item(new Item.Properties().tab(Ecologics.TAB).food(new FoodProperties.Builder().nutrition(3).saturationMod(0.6F).fast().build())));
    ...
    public static final Supplier<Item> AZALEA_BOAT = CommonPlatformHelper.registerItem("azalea_boat", () -> new ModBoatItem("azalea", new Item.Properties().stacksTo(1).tab(Ecologics.TAB)));
    public static final Supplier<Item> FLOWERING_AZALEA_BOAT = CommonPlatformHelper.registerItem("flowering_azalea_boat", () -> new ModBoatItem("flowering_azalea", new Item.Properties().stacksTo(1).tab(Ecologics.TAB)));
}
