...
public class ModFeatures {
    ...
    public static final Supplier<MossPatchFeature> SURFACE_MOSS_PATCH = CommonPlatformHelper.registerFeature("surface_moss_patch", () -> new MossPatchFeature(MossPatchFeatureConfiguration.CODEC));
}
