...
public class ModFeatures {
    ...
    public static final Supplier<SurfaceMossPatchFeature> SURFACE_MOSS_PATCH = CommonPlatformHelper.registerFeature("surface_moss_patch", () -> new SurfaceMossPatchFeature(SurfaceMossPatchFeatureConfiguration.CODEC));
}
