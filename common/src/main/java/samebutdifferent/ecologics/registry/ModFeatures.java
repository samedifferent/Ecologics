...
public class ModFeatures {
    ...
    public static final Supplier<OreVeinFeature> ORE_VEIN = CommonPlatformHelper.registerFeature("ore_vein", () -> new OreVeinFeature(OreVeinFeatureConfiguration.CODEC));
}
