...
public class ModFeatures {
    ...
    public static final Supplier<SurfaceMossFeature> SURFACE_MOSS = CommonPlatformHelper.registerFeature("surface_moss", () -> new SurfaceMossFeature(GlowLichenConfiguration.CODEC));
}
