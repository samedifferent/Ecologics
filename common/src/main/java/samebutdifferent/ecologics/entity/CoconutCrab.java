...
public class CoconutCrab extends Animal implements NeutralMob {
    ...
    private static final Ingredient TEMPT_INGREDIENT = Ingredient.of(ModTags.ItemTags.COCONUT_CRAB_TEMPT_ITEMS);
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pMob) {
    	CoconutCrab crab = ModEntityTypes.COCONUT_CRAB.get().create(pLevel);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new PanicGoal((PathfinderMob)this, 1.5D));
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (itemstack.is(ModBlocks.COCONUT.get().asItem()) && !this.hasCoconut()) {
