...
public class ModItems {
    ...
    public static final RegistryObject<Item> COCONUT_BOAT = ITEMS.register("coconut_boat", () -> new ModBoatItem(false, ModBoat.Type.COCONUT, new Item.Properties().stacksTo(1).tab(Ecologics.TAB)));
    public static final RegistryObject<Item> WALNUT_BOAT = ITEMS.register("walnut_boat", () -> new ModBoatItem(false, ModBoat.Type.WALNUT, new Item.Properties().stacksTo(1).tab(Ecologics.TAB)));
    public static final RegistryObject<Item> AZALEA_BOAT = ITEMS.register("azalea_boat", () -> new ModBoatItem(false, ModBoat.Type.AZALEA, new Item.Properties().stacksTo(1).tab(Ecologics.TAB)));
    public static final RegistryObject<Item> FLOWERING_AZALEA_BOAT = ITEMS.register("flowering_azalea_boat", () -> new ModBoatItem(false, ModBoat.Type.FLOWERING_AZALEA, new Item.Properties().stacksTo(1).tab(Ecologics.TAB)));
    public static final RegistryObject<Item> COCONUT_CHEST_BOAT = ITEMS.register("coconut_chest_boat", () -> new ModBoatItem(true, ModBoat.Type.COCONUT, new Item.Properties().stacksTo(1).tab(Ecologics.TAB)));
    public static final RegistryObject<Item> WALNUT_CHEST_BOAT = ITEMS.register("walnut_chest_boat", () -> new ModBoatItem(true, ModBoat.Type.WALNUT, new Item.Properties().stacksTo(1).tab(Ecologics.TAB)));
    public static final RegistryObject<Item> AZALEA_CHEST_BOAT = ITEMS.register("azalea_chest_boat", () -> new ModBoatItem(true, ModBoat.Type.AZALEA, new Item.Properties().stacksTo(1).tab(Ecologics.TAB)));
    public static final RegistryObject<Item> FLOWERING_AZALEA_CHEST_BOAT = ITEMS.register("flowering_azalea_chest_boat", () -> new ModBoatItem(true, ModBoat.Type.FLOWERING_AZALEA, new Item.Properties().stacksTo(1).tab(Ecologics.TAB)));
}
