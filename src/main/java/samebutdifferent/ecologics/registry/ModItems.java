...
public class ModItems {
    ...
    public static final Item SQUIRREL_SPAWN_EGG = Registry.register(Registry.ITEM, new Identifier(Ecologics.MOD_ID, "squirrel_spawn_egg"), new SpawnEggItem(ModEntityTypes.SQUIRREL, 10051392, 15720061, new Item.Settings().group(Ecologics.TAB)));
    ...
    public static final Item WALNUT = Registry.register(Registry.ITEM, new Identifier(Ecologics.MOD_ID, "walnut"), new Item(new Item.Settings().group(Ecologics.TAB).food(FoodComponents.CARROT)));
    public static final Item WALNUT_SIGN = Registry.register(Registry.ITEM, new Identifier(Ecologics.MOD_ID, "walnut_sign"), new SignItem(new Item.Settings().maxCount(16).group(Ecologics.TAB), ModBlocks.WALNUT_SIGN, ModBlocks.WALNUT_WALL_SIGN));
