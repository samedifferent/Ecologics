...
public class ModSoundEvents {
    ...
    public static final RegistryObject<SoundEvent> COCONUT_CRAB_SHELL_SMASH = SOUND_EVENTS.register("coconut_crab_shell_smash", () -> new SoundEvent(new ResourceLocation(Ecologics.MOD_ID, "entity.coconut_crab.shell_smash")));
