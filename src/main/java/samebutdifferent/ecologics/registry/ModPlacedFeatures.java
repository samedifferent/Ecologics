...
public class ModPlacedFeatures {
    ...
    public static final PlacedFeature PRICKLY_PEAR = ModConfiguredFeatures.PRICKLY_PEAR.placed(CountPlacement.of(512), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
