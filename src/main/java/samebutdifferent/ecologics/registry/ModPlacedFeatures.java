...
public class ModPlacedFeatures {
    ...
    public static final PlacedFeature PRICKLY_PEAR = ModConfiguredFeatures.PRICKLY_PEAR.placed(CountPlacement.of(128), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
    public static final PlacedFeature DESERT_RUIN = ModConfiguredFeatures.DESERT_RUIN.placed(RarityFilter.onAverageOnceEvery(13), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
