...
public class ModConfiguredFeatures {
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> THIN_ICE_PATCH = CONFIGURED_FEATURES.register("thin_ice_patch", () -> new ConfiguredFeature<>(ModFeatures.THIN_ICE.get(), new DiskConfiguration(RuleBasedBlockStateProvider.simple(ModBlocks.THIN_ICE.get()), BlockPredicate.matchesBlocks(List.of(Blocks.ICE)), UniformInt.of(2, 3), 1)));
