...
public class ModConfiguredFeatures {
    ...
    public static final PlacedFeature PRICKLY_PEARS = PRICKLY_PEAR.placed(CountPlacement.of(150), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
