...
public class ModEntityTypes {
    ...
    public static final RegistryObject<EntityType<Squirrel>> SQUIRREL = ENTITY_TYPES.register("squirrel", () -> EntityType.Builder.of(Squirrel::new, MobCategory.CREATURE).sized(1.0F, 1.0F).clientTrackingRange(8).build(new ResourceLocation(Ecologics.MOD_ID, "squirrel").toString()));
}
