...
public class ModSigns {
    ...
    public static final SignType AZALEA_SIGN_TYPE = SignTypeHelper.register("azalea");
    ...
    public static final SignType FLOWERING_AZALEA_SIGN_TYPE = SignTypeHelper.register("flowering_azalea");
    ...
    public static final SignType WALNUT_SIGN_TYPE = SignTypeHelper.register("walnut");
    ...
    public static final SignType COCONUT_SIGN_TYPE = SignTypeHelper.register("coconut");
