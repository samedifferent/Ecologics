...
public class ModBlockFamilies {
    ...
    public static final BlockFamily FLOWERING_AZALEA_PLANKS = familyBuilder(ModBlocks.FLOWERING_AZALEA_PLANKS.get()).button(ModBlocks.AZALEA_BUTTON.get()).fence(ModBlocks.FLOWERING_AZALEA_FENCE.get()).fenceGate(ModBlocks.FLOWERING_AZALEA_FENCE_GATE.get()).pressurePlate(ModBlocks.AZALEA_PRESSURE_PLATE.get()).sign(ModBlocks.FLOWERING_AZALEA_SIGN.get(), ModBlocks.FLOWERING_AZALEA_WALL_SIGN.get()).slab(ModBlocks.FLOWERING_AZALEA_SLAB.get()).stairs(ModBlocks.FLOWERING_AZALEA_STAIRS.get()).door(ModBlocks.FLOWERING_AZALEA_DOOR.get()).trapdoor(ModBlocks.FLOWERING_AZALEA_TRAPDOOR.get()).recipeGroupPrefix("wooden").recipeUnlockedBy("has_planks").getFamily();
