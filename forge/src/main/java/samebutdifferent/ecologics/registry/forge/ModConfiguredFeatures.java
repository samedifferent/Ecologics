...
public class ModConfiguredFeatures {
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> SURFACE_MOSS_PATCH = CONFIGURED_FEATURES.register("surface_moss_patch", () -> new ConfiguredFeature<>(ModFeatures.SURFACE_MOSS_PATCH.get(), new SurfaceMossPatchFeatureConfiguration(96, 7, 3, true, true, true, List.of(Blocks.STONE, Blocks.ANDESITE, Blocks.DIORITE, Blocks.GRANITE, Blocks.DRIPSTONE_BLOCK, Blocks.CALCITE, Blocks.TUFF, Blocks.DEEPSLATE))));
